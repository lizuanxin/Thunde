...
export namespace const_data
{
    ...
    [
        ...
        {Id: '{00000000-0000-4000-4100-000000000001}', Author: 'UltraCreation Team',
            Category_Id: Category.muscle_training.Id, Mode_Id: null, Name: 'fb_a',
            BodyParts: [Body.thigh], Icon: 0xe954},
        {Id: '{00000000-0000-4000-4100-000000000002}', Author: 'UltraCreation Team',
            Category_Id: Category.muscle_training.Id, Mode_Id: null, Name: 'fb_b',
            BodyParts: [Body.calf], Icon: 0xe955},
        {Id: '{00000000-0000-4000-4100-000000000003}', Author: 'UltraCreation Team',
            Category_Id: Category.muscle_training.Id, Mode_Id: null, Name: 'fb_c',
            BodyParts: [Body.abdomen], Icon: 0xe953},
